...
public class DeleteDetails extends JFrame implements ActionListener {
    ...
    DeleteDetails(String username) {
        ...
        delete.addActionListener(this);  // Added action listener for the delete button
        add(delete);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == delete) {
            try {
                Conn c = new Conn();
                c.s.executeUpdate("DELETE FROM Taccount WHERE username='" + username + "'");
                c.s.executeUpdate("DELETE FROM Cx WHERE username='" + username + "'");
    ...
    public static void main(String[] args) {
        new DeleteDetails("riya25");  // Pass the username dynamically or test with a specific one
    }
}
